	...
	<form name="noticeform" method="post"
		...
		<table class="grid" cellspacing="1" width="100%">
			...
			<input type="hidden" name="forwardurl"
				value="/admin/noticemanager.do?actiontype=get&forwardurl=/admin/noticemanager.jsp" />
			<tr>
			...
			<tr>
				...
				<td><input name="title" placeholder="标题"
					...
					value="${requestScope.notice.title}" class="input-txt" type="text"
					id="txtTitle" /></td>
			</tr>
			
			<tr>
				<td align="right">内容:</td>
				<td colspan="3"><textarea name="content" id="txtContent"
						style="width:98%;height:200px;">${requestScope.notice.content}</textarea>
				</td>
			</tr>
			<tr>
				<td colspan="4">
