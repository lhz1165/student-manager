			    ...
			    $("#btnDelete").click(function(){
			        ...
			        $(".check:checked").each(function(index,domEle){
			             ...
			             top.$.dialog.confirm("你确定要注销课程信息?", function(){
				             window.location.href=encodeURI('${pageContext.request.contextPath}/admin/kechengmanager.do?actiontype=delete&id='+id);
				         });
			        });
			    });
					...
					<td>
					   <%if(temkecheng!=null&&temkecheng.getStatus()!=null&&temkecheng.getStatus().equals("选课结束")){ %>
					      <form style="display: inline" action="${pageContext.request.contextPath}/admin/kechengmanager.do">
					            ...
					            <input type="hidden" name="forwardurl" value="/admin/kechengmanager.do?actiontype=get"/>
					   ...
					   <%} %>
					    <a class="btn btn-info"
						    href="${pageContext.request.contextPath}/admin/kechengmanager.do?actiontype=load&id=<%=temkecheng.getId()%>"><i
							class="icon-edit icon-white"></i>修改</a> 
						<a class="btn btn-success"
						href="${pageContext.request.contextPath}/admin/kechengdetails.jsp?id=<%=temkecheng.getId()%>"><i
