	...
	<form name="teacherform" method="post"
		...
		<table class="grid" cellspacing="1" width="100%">
			...
			<tr>
				...
				<td>${requestScope.teacher.tno}<input name="tno" placeholder="工号"
					validate="{required:true,messages:{required:'请输入工号'}}"
					value="${requestScope.teacher.tno}" class="input-txt" type="hidden"/></td>
			...
			<tr>
				...
				<td> <select  class="dropdown" name="zhiwei">
