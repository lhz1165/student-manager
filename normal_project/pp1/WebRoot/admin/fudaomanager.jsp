...
<html>
			...
			$(function() {
			    $("#btnDelete").click(function(){
			       var ids = $(".check[type=checkbox]:checked").serialize();
					...
					$.ajax({
			                     url: "${pageContext.request.contextPath}/admin/fudaomanager.do?actiontype=delete",
			                     method: 'post',
			                     data: ids,
	...
	<div class="search-title">
		...
		<div class="description">
			<a
				href="${pageContext.request.contextPath}/admin/fudaomanager.do?actiontype=load&forwardurl=/admin/fudaoadd.jsp">新建辅导班级</a>
		</div>
	</div>
	<!-- 搜索控件开始 -->
		...
		<tbody>
			...
			<tr>
				<td>&nbsp<input  class="check"
					name="ids" type="checkbox" value='<%=dr.getString("id")%>'/></td>
				<td><%=dr.getString("tno")%>-<%=dr.getString("tname") %></td>
				<td><%=dr.getString("bname")%></td>
				<td><a class="orange-href"
					href="${pageContext.request.contextPath}/admin/fudaomanager.do?actiontype=load&id=<%=dr.getString("id")%>&forwardurl=/admin/fudaoadd.jsp">修改</a>
