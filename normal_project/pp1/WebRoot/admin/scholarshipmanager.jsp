			...
			$(function() {
			    $("#btnDelete").click(function(){
			       var ids = $(".check[type=checkbox]:checked").serialize();
					...
					$.ajax({
			                     url: "${pageContext.request.contextPath}/admin/scholarshipmanager.do?actiontype=delete",
			                     method: 'post',
			                     data: ids,
				...
				<tbody>
					<tr>
						<td>
							...
							<input type="hidden" name="forwardurl" value="/admin/scholarshipmanager.jsp" />
	...
	<table id="scholarship" width="100%" border="0" cellspacing="0" cellpadding="0" class="ui-record-table">
		...
		<tbody>
			...
			<tr>
				<td>
					&nbsp
					<input id="chk<%=temscholarship.getId()%>" class="check" name="ids" type="checkbox" value='<%=temscholarship.getId()%>'>
				</td>
				...
				<td>
					<a class="orange-href" href="${pageContext.request.contextPath}/admin/scholarshipmanager.do?actiontype=load&id=<%=temscholarship.getId()%>&forwardurl=/admin/scholarshipadd.jsp">修改</a>
					<a class="orange-href" href="${pageContext.request.contextPath}/admin/scholarshipdetails.jsp?id=<%=temscholarship.getId()%>">查看</a>
				</td>
			</tr>
			<%}}%>
		</tbody>
