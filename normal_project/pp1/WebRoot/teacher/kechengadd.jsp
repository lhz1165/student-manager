	...
	<form name="kechengform" class="form-horizontal" method="post"
		...
		<table class="grid" cellspacing="1" width="100%">
			...
			<input type="hidden" name="forwardurl"
				value="/admin/kechengmanager.do?actiontype=get&tno=${teacher.tno}&forwardurl=/teacher/kechengmanager.jsp" />
			<tr>
			...
			<tr>
				...
				<td><input name="subno"
					...
					value="${requestScope.kecheng.subno}" class="input-txt" type="text"
					id="txtSubno" /></td>
			</tr>
			<tr>
