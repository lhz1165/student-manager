...
<html>
			...
			$(function() {
			    $("#btnDelete").click(function(){
			       var ids = $(".check[type=checkbox]:checked").serialize();
					...
					$.ajax({
			url: "${pageContext.request.contextPath}/admin/earlywarnmanager.do?actiontype=delete",
			                     method: 'post',
			                     data: ids,
	...
	<div class="search-title">
		...
		<div class="description">
			<a href="${pageContext.request.contextPath}/admin/earlywarnmanager.do?actiontype=load&forwardurl=/admin/earlywarnadd.jsp">新建学生预警</a>
		</div>
	</div>
	<!-- 搜索控件开始 -->
				...
				<tbody>
					<tr>
						<td>
							...
							<input type="hidden" name="forwardurl" value="/admin/earlywarnmanager.jsp" />
	...
	<table id="earlywarn" width="100%" border="0" cellspacing="0" cellpadding="0" class="ui-record-table">
		...
		<tbody>
			...
			<tr>
				<td>
					&nbsp
					<input id="chk<%=temearlywarn.getId()%>" class="check" name="ids" type="checkbox" value='<%=temearlywarn.getId()%>'/>
				</td>
				<td><%=temearlywarn.getStno()%></td>
				<td><%=temearlywarn.getStname()%></td>
				...
				<td>
					<a class="orange-href" href="${pageContext.request.contextPath}/admin/earlywarnmanager.do?actiontype=load&id=<%=temearlywarn.getId()%>&forwardurl=/admin/earlywarnadd.jsp">修改</a>
					<a class="orange-href" href="${pageContext.request.contextPath}/admin/earlywarndetails.jsp?id=<%=temearlywarn.getId()%>">查看</a>
				</td>
			</tr>
			<%}}%>
		</tbody>
