        ...
        <div id="logo">
            <span style="display: block; position: relative; width:660px; height: 68px;">
                <font style="position: absolute; top: 20px; font-family: 微软雅黑; font-weight: bold;
                    font-size: 30px; color: #1c7ec7; letter-spacing: 3px; border: 0px;">学生管理信息系统(${teacher.zhiwei})
                </font>
            </span>
        </div>
        <div id="menu">
    ...
    <div  id="content">
        <table cellspacing="0" cellpadding="0" border="0" width="100%">
            <tr>
                ...
                <td valign="top">
                    <iframe src="${pageContext.request.contextPath}/teacher/accountinfo.jsp" style="padding-bottom:30px;" frameborder="0" width="100%"  name="main"
                        id="main">
                    </iframe>
                </td>
            </tr>
